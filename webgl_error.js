...
{
  if (shader_failed) return GF_BAD_PARAM;
...
//  pck_tx.upload(ipck);
  ...
  if (!programInfo1) {
      programInfo1 = setupProgram(gl, vsSource, fsSource1, 'vidTx');
      if (!programInfo1) { shader_failed=true; return GF_OK; }
  }
  if (!programInfo2) {
      programInfo2 = setupProgram(gl, vsSource, fsSource2, 'txt1');
      if (!programInfo2) { shader_failed=true; return GF_OK; }
  }
  // Draw the scene
