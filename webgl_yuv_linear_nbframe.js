...
uniform float u_coefw;
uniform float u_coefv;
...
function setupProgram(gl, vsSource, fsSource)
{
    ...
    return {
        ...
        uniformLocations: {
            ...
            coefw: gl.getUniformLocation(shaderProgram, 'u_coefw'),
            coefv: gl.getUniformLocation(shaderProgram, 'u_coefv'),
        },
    };
}
...
function drawScene(gl, programInfo, buffers) {
    ...
    let coefw = (nb_frames%100)/100.0;
    let coefv = (nb_frames%100)/100.0;
    ...
    gl.uniform1f(programInfo.uniformLocations.coefw,coefw);
    gl.uniform1f(programInfo.uniformLocations.coefv,coefv);
